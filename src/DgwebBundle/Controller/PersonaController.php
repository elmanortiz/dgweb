...
use DgwebBundle\Entity\Persona;
use DgwebBundle\Form\PersonaType;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DgwebBundle:Persona')->findAll();
     ...
     * @Method("POST")
     * @Template("DgwebBundle:Persona:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DgwebBundle:Persona')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DgwebBundle:Persona:edit.html.twig")
     */
