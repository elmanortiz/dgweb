...
use DgwebBundle\Entity\Rol;
use DgwebBundle\Form\RolType;
...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DgwebBundle:Rol')->findAll();
     ...
     * @Method("POST")
     * @Template("DgwebBundle:Rol:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DgwebBundle:Rol')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DgwebBundle:Rol:edit.html.twig")
     */
