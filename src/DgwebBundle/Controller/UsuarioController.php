...
use DgwebBundle\Entity\Usuario;
use DgwebBundle\Form\UsuarioType;
...
class UsuarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('DgwebBundle:Usuario')->findAll();
     ...
     * @Method("POST")
     * @Template("DgwebBundle:Usuario:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('DgwebBundle:Usuario')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("DgwebBundle:Usuario:edit.html.twig")
     */
